      ...
      <section className={`bg-[#F0F0F0]/95 border-t border-panel-border backdrop-blur-md shrink-0 overflow-x-hidden md:h-48 ${hasInitialized ? 'transition-all duration-700 ease-[cubic-bezier(0.2,0.8,0.2,1)] translate-y-0 opacity-100' : ''}`}>
        ...
        <div className="md:hidden flex flex-col divide-y divide-panel-border">
          ...
          <div className="p-4">
            ...
            <ul className="text-[10px] text-ink-dim space-y-2">
              <li className="flex gap-2 pb-2 border-b border-dashed border-gray-300">
                <span className="text-red-600">&gt;</span>
                <span>Ensure file is a valid PDF, not a renamed document</span>
              </li>
          ...
          <div className="p-4">
            ...
            <div className="border border-red-300 bg-red-50 flex flex-col items-center justify-center py-4">
              <span className="text-2xl sm:text-3xl font-bold text-red-600">FAIL</span>
              <span className="text-[8px] font-bold text-ink-dim tracking-widest mt-1">INVALID_PDF_STRUCTURE</span>
            </div>
          </div>
        </div>
