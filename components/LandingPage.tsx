...
export function LandingPage({ onUpload }: LandingPageProps) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-start sm:justify-center px-2 sm:px-6 mt-6 sm:mt-0">
      ...
      <div className="w-full max-w-[800px] mb-2 sm:mb-8 px-2 sm:px-0">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center py-8 sm:py-12 text-center border border-dashed border-panel-border">
            ...
            <h2 className="text-sm lg:text-[16px] font-bold text-ink-main tracking-widest mb-1">DROP_PDF_STREAM</h2>
        ...
        <div className="bg-[#F0F0F0] border border-panel-border p-4 sm:p-6">
          ...
          <div className="flex items-stretch gap-3 flex-1 min-w-0">
            <div className="w-6 border border-ink-main flex items-center justify-center shrink-0 bg-white self-stretch">
              <span className="text-[10px] sm:text-[10px] lg:text-[12px] font-bold text-ink-main">01</span>
            </div>
            <div className="min-w-0">
              <h3 className="text-[10px] sm:text-[10px] lg:text-[12px] font-bold text-ink-main tracking-widest mb-0.5">UPLOAD</h3>
              <p className="hidden sm:block text-[10px] sm:text-[10px] lg:text-[12px] text-ink-dim leading-relaxed lg:leading-[1.6] lg:tracking-[-1%]">Import a PDF file in the workspace to get started</p>
                            <p className="sm:hidden text-[10px] text-ink-dim leading-relaxed">Import a PDF file to start</p>
            </div>
          </div>
          ...
          <div className="flex items-stretch gap-3 flex-1 min-w-0">
            <div className="w-6 border border-ink-main flex items-center justify-center shrink-0 bg-white self-stretch">
              <span className="text-[10px] sm:text-[10px] lg:text-[12px] font-bold text-ink-main">02</span>
            </div>
            <div className="min-w-0">
              <h3 className="text-[10px] sm:text-[10px] lg:text-[12px] font-bold text-ink-main tracking-widest mb-0.5">CONFIGURE</h3>
              <p className="hidden sm:block text-[10px] sm:text-[10px] lg:text-[12px] text-ink-dim leading-relaxed lg:leading-[1.6] lg:tracking-[-1%]">Adjust physics, shadows, and flip mechanics</p>
          ...
          <div className="flex items-stretch gap-3 flex-1 min-w-0">
            <div className="w-6 border border-ink-main flex items-center justify-center shrink-0 bg-white self-stretch">
              <span className="text-[10px] sm:text-[10px] lg:text-[12px] font-bold text-ink-main">03</span>
            </div>
            <div className="min-w-0">
              <h3 className="text-[10px] sm:text-[10px] lg:text-[12px] font-bold text-ink-main tracking-widest mb-0.5">SHARE</h3>
              <p className="hidden sm:block text-[10px] sm:text-[10px] lg:text-[12px] text-ink-dim leading-relaxed lg:leading-[1.6] lg:tracking-[-1%]">Get a unique URL to share the interactive flipbook</p>
